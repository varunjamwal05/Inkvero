...
const Login = () => {
    ...
    return (
        <div className="h-full flex items-center justify-center relative overflow-hidden">
            ...
            {/* 1. Background Depth - Kept subtle as requested or removed if AuthBackground covers it? 
               User said "Add a cinematic... background... make it feel immersive".
               AuthBackground has its own overlays.
               The existing radial gradient might conflict or add nice tint.
               Let's keep it but ensure AuthBackground is behind it if we want the tint, OR remove it if AuthBackground handles everything.
               AuthBackground has z-index -10. 
               This div filters it. User said "Layer 3 — Keep existing card backdrop blur". Card is separate.
               User said "Layer 1... Layer 2...". AuthBackground implements Layer 1 & 2.
               I will comment out or remove the old simple gradient to avoid muddying the carefully crafted AuthBackground layers.
            */}
            ...
            <div className="card w-full max-w-md bg-[#050505]/80 backdrop-blur-xl border border-white/[0.05] shadow-[0_20px_50px_rgba(0,0,0,0.7)] rounded-sm p-8 md:p-12 relative z-10 transition-all duration-500 hover:border-[#D4AF37]/20">
                <div className="text-center mb-10">
                    <h2 className="text-3xl font-heading text-highlight">Welcome Back</h2>
                    <p className="text-secondary/60 mt-2">Sign in to continue your journey</p>
                </div>
